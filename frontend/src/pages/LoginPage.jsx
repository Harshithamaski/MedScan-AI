...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 bg-grid flex items-center justify-center px-4 relative overflow-hidden">
      <div className="orb orb-teal w-96 h-96 -top-20 -left-20" />
      <div className="orb orb-blue w-80 h-80 -bottom-10 -right-10" />
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Sign in to access your health reports</p>
        </div>
